...
<!--{"pinCode":false,"dname":"3c60b496-fa08-4140-9ceb-1054c5877a9c","codeMode":"js"}-->
```js
flare = (FileAttachment("flare.json").json())
```

<!--{"pinCode":false,"dname":"37cfbeae-f1a9-45a3-9633-fcd839d0c910","codeMode":"js"}-->
```js
howto("Sunburst")
```

<!--{"pinCode":false,"dname":"4f4e99fd-7813-4e48-b4a2-d6d8a33ed024","codeMode":"js"}-->
```js
Sunburst = (function Sunburst(data, { // data is either tabular (array of objects) or hierarchy (nested objects)
